	...
	def __init__(self):
		...
		def start_point():			
			...
			if not successx_0:
				...
				tkMessageBox.showinfo("Error", "Recover the robot to the starting point!")
				os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/error.wav")
				return None
   			else:
		...
		def computer_desk():			
			...
			if not success0_1:
				...
				if state0_1 == GoalStatus.SUCCEEDED:
					os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/computer.wav")
				else:
					tkMessageBox.showinfo("Error", "Recover the robot to the starting point!")
					os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/error.wav")
					return None
		...
		def electric_electronics_desk():
			...
			if not success0_2:
				...
				if state0_2 == GoalStatus.SUCCEEDED:
		    			os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/electrical.wav")
				else: 
				    	tkMessageBox.showinfo("Error", "Recover the robot to the starting point!")
					os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/error.wav")
					return None
		...
		def mechanical_desk():			
			...
			if not success0_3:
				...
				if state0_3 == GoalStatus.SUCCEEDED:
					os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/mechanical.wav")
				else:
					tkMessageBox.showinfo("Error", "Recover the robot to the starting point!")
					os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/error.wav")
					return None
		...
		def industrial_desk():			
			...
			if not success0_4:
				...
				if state0_4 == GoalStatus.SUCCEEDED:
					os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/industrial.wav")
				else:
					tkMessageBox.showinfo("Error", "Recover the robot to the starting point!")
					os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/error.wav")
					return None
		...
		menubar.add_cascade(label = "Recover Turtlebot!", menu = recovermenu)
		recovermenu.add_command(label = "Return To The Starting Point", command = start_point)
		...
		menubar.add_cascade(label="PLEASE SELECT A DEPARTMENT", font = ("Verdana 15 bold"))

		computerimage = ImageTk.PhotoImage(PIL.Image.open('/home/kahya/Desktop/INTROBOT/images/computer.jpg'))
		computerbutton = Button(gui, command = computer_desk, image = computerimage).grid(row = 0, column = 0)

		electricalimage = ImageTk.PhotoImage(PIL.Image.open('/home/kahya/Desktop/INTROBOT/images/electrical.jpg'))
		electricalbutton = Button(gui, command = electric_electronics_desk, image = electricalimage).grid(row = 0,column = 1)

		mechanicalimage = ImageTk.PhotoImage(PIL.Image.open('/home/kahya/Desktop/INTROBOT/images/mechanical.jpg'))
		mechanicalbutton = Button(gui, command = mechanical_desk, image = mechanicalimage).grid(row = 1, column = 0)

		industrialimage = ImageTk.PhotoImage(PIL.Image.open('/home/kahya/Desktop/INTROBOT/images/industrial.jpg'))
		industrialbutton = Button(gui, command = industrial_desk, image = industrialimage).grid(row = 1, column = 1)
		...
		os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/logout.wav")
...
if __name__ == '__main__':  
	...
	try:
		os.system("aplay /home/kahya/Desktop/INTROBOT/sounds/welcome.wav")
		GoToPose()
